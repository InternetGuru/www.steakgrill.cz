...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="//p[preceding-sibling::h1[1][contains(@id, 'steakgrill')]]">
    ...
    <ul class="button-list">
      ...
      <li><a class="button button-img" href="#denni_nabidka"><span class="fas fa-3x fa-utensils">i</span>Denní nabídka s&#160;sebou</a></li>
      <li><a class="button button-img" href="#stala_nabidka"><span class="fas fa-3x fa-clipboard-list">i</span>Stálá nabídka s&#160;sebou</a></li>
